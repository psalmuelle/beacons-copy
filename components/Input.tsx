...
const Input:React.FC<InputProps> = ({type, label})=>{
    return(
        ...
        <input
          className="peer h-full w-full rounded-[7px] border border-t-transparent bg-transparent px-3 py-2.5 text-blue-gray-700 outline outline-0 transition-all placeholder-shown:border placeholder-shown:border-blue-gray-200 placeholder-shown:border-t-gray-200 focus:border-2 focus:border-secondary focus:border-t-transparent focus:outline-0 disabled:border-0"
          placeholder=" "
          type={type}
        />
